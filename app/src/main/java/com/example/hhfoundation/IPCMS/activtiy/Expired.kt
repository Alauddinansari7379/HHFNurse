...
import com.example.hhfoundation.databinding.ActivityExpriedBinding
...
class Expired : AppCompatActivity(), UploadRequestBody.UploadCallback  {
    private lateinit var binding:ActivityExpriedBinding
    private  var context=this@Expired
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding=ActivityExpriedBinding.inflate(layoutInflater)
    ...
    private fun apiCallAddLama() {
        ...
        ApiClient.apiService.addExpireDetails(
            sessionManager.ionId.toString(),
            sessionManager.idToken.toString(),
            sessionManager.group.toString(),
            presId,
            expiredDate,
            binding.edtCause.text.toString().trim(),
            MultipartBody.Part.createFormData("death_certi", file.name, body),
            ...
            override fun onResponse(
                ...
                try {
                    ...
                    } else if (response.body()!!.message.contentEquals("ExpireData added")) {
